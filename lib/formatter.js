...
function formatData(data){
  ...
  bids_data = combineData([bittrexData, poloniexData], "bids")
  asks_data = combineData([bittrexData, poloniexData], "asks")
...
function placeholderRowData(data, orderType){
  ...
  sortedPrices.forEach(function(price){
    placeholderData[price] = {'volumes': {'bittrex': 0, 'poloniex': 0},
                              'highlight': false}
  })
