...
function askRows(data){
  ...
  Object.keys(combined).forEach(function(price){
    ...
    // rows += '<tr class =' + '><th scope="row">' + price + '</th>'
    rows += '<tr class =' + askColorClass(price, data) + '><th scope="row">' + price + '</th>'
          + '<td>' + bittrexVol + '</td>'
          + '<td>' + poloniexVol + '</td>'
          + '<td>' + total + '</td></tr>'
  })
...
function bidRows(data){
  ...
  Object.keys(combined).forEach(function(price){
    ...
    rows += '<tr class =' + bidColorClass(price, data) + '><th scope="row">' + price + '</th>'
          + '<td>' + bittrexVol + '</td>'
          + '<td>' + poloniexVol + '</td>'
          + '<td>' + total + '</td>'
  })
